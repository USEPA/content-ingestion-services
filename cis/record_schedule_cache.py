...
def process_schedule_data(schedule_dict):
  return RecordScheduleInformation(
      ...
      function_number=str(schedule_dict['function_number']),
      ...
      retention_year=int(schedule_dict['retention_year']),
      retention_month=int(schedule_dict['retention_month']),
      retention_day=int(schedule_dict['retention_day']),
