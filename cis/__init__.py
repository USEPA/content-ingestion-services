...
def create_app(model_path, label_mapping_path, config_path, mailbox_data_path, dnul_path, database_uri, tika_server=None, cis_server=None, ezemail_server=None, upgrade_db=False):
